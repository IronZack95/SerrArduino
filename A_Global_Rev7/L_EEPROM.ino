...
void EEPROM_RAM_ResetToDefault(){
      byte int_table_1[] = {TH,MAXTEMP,MINTEMP,MINUMID,MAXUMID,PERVENT,DURVENT,MATNSTRT_H,MATNSTRT_M,SERASTRT_H,SERASTRT_M,DURIRRIG_M,DURIRRIG_S,PERIRGZFIX,DURIRGZFIX};
